...
(function ($) {
    let $hyoo_jsperf = (() => {
        class $hyoo_jsperf extends $.$mol_page {
            ...
            Body() {
                return ((obj) => {
                    obj.pages = () => [this.Common(), this.Cases_pane()];
                    return obj;
                })(new this.$.$mol_book2());
            }
            Common() {
                return ((obj) => {
                    obj.sub = () => [this.Prefix(), this.Postfix()];
                    return obj;
                })(new this.$.$mol_scroll());
            }
            Prefix() {
            ...
            tools() {
                return [this.Permalink(), this.New(), this.Run()];
            }
            Permalink() {
                return ((obj) => {
...
(function ($) {
    let $hyoo_jsperf_case = (() => {
        class $hyoo_jsperf_case extends $.$mol_view {
            ...
            columns() {
                return [this.Source(), this.Result_rows()];
            }
            Source() {
                return ((obj) => {
        ...
        return $hyoo_jsperf_case;
    })();
    $.$hyoo_jsperf_case = $hyoo_jsperf_case;
})($ || ($ = {}));
(function ($) {
    let $hyoo_jsperf_case_result = (() => {
        class $hyoo_jsperf_case_result extends $.$mol_view {
            ...
            Stats() {
                return ((obj) => {
                    obj.sub = () => [this.title(), this.Frequency(), " ≈ ", this.Time(), " ⋅ ", this.Iterations()];
                    return obj;
                })(new this.$.$mol_view());
            }
            title() {
        ...
        return $hyoo_jsperf_case_result;
    })();
