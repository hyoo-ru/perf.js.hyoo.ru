...
(function ($) {
    class $hyoo_js_perf extends $mol_page {
        ...
        Case(index) {
            ...
            obj.prefix = (val) => this.case_prefix(index, val);
        ...
        Hint() {
            const obj = new this.$.$mol_text_code();
            obj.text = () => "{#} // iterations count/number\n\n// loads JS script\n$mol_import.script( uri )\n\n// loads ESM module\n$mol_import.module( uri )\n\n// checks for truth\n$mol_assert_ok( actual )\n\n// checks for identity\n$mol_assert_equal( actual, expected )\n\n// checks for equivalence\n$mol_assert_like( actual, expected )";
            return obj;
        }
        Common() {
            const obj = new this.$.$mol_scroll();
    ...
    class $hyoo_js_perf_case_result extends $mol_view {
        ...
        Memory_per_iteration() {
            const obj = new this.$.$mol_view();
            obj.attr = () => ({
                title: "Required: --js-flags=\"--expose-gc\" --enable-precise-memory-info"
            });
            obj.sub = () => [
